    ...
    <section id="about" className="py-16 bg-gray-50 border-b border-gray-200">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <div className="bg-white p-6 sm:p-8 rounded-xl border border-gray-200 shadow-xs space-y-4 text-gray-700 leading-relaxed">
            <p>
              I am an Electronics and Communication Engineering undergraduate at Sri Eshwar College of Engineering (CGPA: 8.14) with a strong foundation in <strong>Software Engineering</strong>, <strong>Backend Development</strong>, and <strong>Artificial Intelligence</strong>.
            </p>
            <p>
