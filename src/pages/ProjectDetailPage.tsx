...
import { ArrowLeft, ExternalLink, AlertCircle, CheckCircle, Lightbulb, Cpu } from 'lucide-react';
  ...
  return (
    <div className="py-12 bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 border-b border-gray-200 pb-8">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-gray-900 hover:bg-gray-800 text-white font-medium text-sm transition-colors"
            >
        ...
        <div className="mb-12">
          <h2 className="text-lg font-bold text-gray-900 mb-4">System Architecture</h2>
          <ArchitectureDiagram slug={project.slug} />
          <p className="text-xs text-gray-500 font-mono mt-3 leading-relaxed">
        ...
        {/* Key Features */}
        <div className="mb-12">
          <h2 className="text-lg font-bold text-gray-900 mb-4">Key System Capabilities</h2>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {project.challenges.map((c, idx) => (
                <li key={idx} className="p-4 bg-gray-50 rounded-lg border border-gray-200 text-xs text-gray-700 leading-relaxed">
                  {c}
                </li>
              ))}
            </ul>
