            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2.5">
                {project.techStack.map((tech) => (
                  <span
                    key={tech}
                    className="inline-flex items-center gap-2.5 px-4 py-2 rounded-xl bg-slate-900 border border-slate-800 text-sm font-semibold text-slate-100"
                  >
                    <TechLogo name={tech} className="w-5 h-5 flex-shrink-0" />
                    <span>{tech}</span>
                  </span>
                ))}
              </div>
